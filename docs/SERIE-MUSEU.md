...
| 8 | Onda 1 — loops e coroa | Emissor espontâneo de loops coronais, emissor de coroa via `phenomena.corona`, famílias novas na coleção (5→8), controles negativos | qa:edu estendido + idempotência | "Explore até um cartão 'Loops coronais' aparecer sozinho; a coleção mostra 8 famílias." | 🚧 em andamento |
